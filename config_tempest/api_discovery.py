...
class IdentityService(VersionedService):
    def get_extensions(self):
        ...
        if 'v2.0' in self.service_url:
            get_url = self.service_url + '/extensions'
        elif 'v3' in self.service_url:
            get_url = self.service_url[
                :self.service_url.rfind('v3')] + '/extensions'
        else:
            get_url = self.service_url + '/v2.0/extensions'
